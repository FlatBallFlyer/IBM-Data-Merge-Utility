...
public class DirectiveDeserializer implements JsonDeserializer<AbstractDirective> {
	...
	public AbstractDirective deserialize(JsonElement json, Type directive, JsonDeserializationContext context) {
		...
		switch (myType) {
			case Directives.TYPE_REPLACE_VALUE: 		return context.deserialize(json, ReplaceValue.class);
			case Directives.TYPE_REQUIRE: 			return context.deserialize(json, Require.class);
			case Directives.TYPE_SQL_INSERT: 		return context.deserialize(json, InsertSubsSql.class);
			case Directives.TYPE_SQL_REPLACE_COL: 	return context.deserialize(json, ReplaceColSql.class);
			case Directives.TYPE_SQL_REPLACE_ROW: 	return context.deserialize(json, ReplaceRowSql.class);
