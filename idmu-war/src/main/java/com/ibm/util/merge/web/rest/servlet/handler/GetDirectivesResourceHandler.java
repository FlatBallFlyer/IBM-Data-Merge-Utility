 ...
 * GET /idmu/directives
 */
public class GetDirectivesResourceHandler implements RequestHandler {

    private static final Logger log = Logger.getLogger(GetDirectivesResourceHandler.class);
