 ...
 */
public class HtmlErrorResult implements Result {
    private MergeException exception;
    private String errTemplate;
    private TemplateFactory factory;

    public HtmlErrorResult(String message, TemplateFactory tf, String errTemplate) {
        this.exception = new MergeException(message, "", null);
        this.errTemplate = "error." + errTemplate + ".";
        this.factory = tf;
    }

    public HtmlErrorResult(MergeException exception, TemplateFactory tf, String errTemplate) {
