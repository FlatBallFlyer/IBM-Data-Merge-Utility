...
CREATE TABLE IDMU_TEMPLATE (
  COLLECTION VARCHAR2(100) NOT NULL,
  TEMPLATE_NAME VARCHAR2(100) DEFAULT '' NOT NULL,
  COLUMN_VALUE VARCHAR2(100) DEFAULT '' NOT NULL,
  OUTPUT_FILE VARCHAR2(250) DEFAULT '' NULL,
