...
-- Table CONTACT
-- -----------------------------------------------------
CREATE TABLE CONTACT ( IDCONTACT INT, IDCUSTOMER INT, NAME VARCHAR(45), PREFERENCE VARCHAR(45), EMAIL VARCHAR(45), PHONE VARCHAR(45));

-- -----------------------------------------------------
-- Table CORPORATE
-- -----------------------------------------------------
CREATE TABLE CORPORATE ( IDCORPORATE INT, FROM_VALUE VARCHAR(45), TO_VALUE VARCHAR(45));

-- -----------------------------------------------------
-- Table CUSTOMER
-- -----------------------------------------------------
CREATE TABLE CUSTOMER ( IDCUSTOMER INT, PRIMARY VARCHAR(45), NAME VARCHAR(45), REVENUE INT, PROFIT INT, STREET VARCHAR(95), CITY VARCHAR(45), STATE VARCHAR(45), ZIP VARCHAR(45), PHONE VARCHAR(45));
commit;
...
INSERT INTO CUSTOMER (IDCUSTOMER,PRIMARY,NAME,REVENUE,PROFIT,STREET,CITY,STATE,ZIP,PHONE) VALUES (15,'Kenneth','ATT Technologies',1526,56,'5414 Hidden Byway','Beersville','HI','96732-5653','(808) 216-1044');
...
INSERT INTO CUSTOMER (IDCUSTOMER,PRIMARY,NAME,REVENUE,PROFIT,STREET,CITY,STATE,ZIP,PHONE) VALUES (19,'Stephen','Goodyear Tire and Rubber',1090,48,'5479 Silver Villas','Effort','MN','56108-2359','(763) 274-6998');
