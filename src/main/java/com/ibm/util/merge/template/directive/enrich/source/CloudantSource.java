...
/**
 * The Class CloudantSource.
 */
public class CloudantSource extends AbstractSource {
	private String databaseName;

	public CloudantSource() {
		super();
		this.setType(AbstractSource.SOURCE_CLOUDANT);
	}

	@Override
	public AbstractProvider getProvider() throws MergeException {
		return new CloudantProvider(this);
	}
